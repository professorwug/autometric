  ...
  'syms': { 'autometric.autometric': { 'autometric.autometric.StringGeodesic': ( 'library/string-geodesics.html#stringgeodesic',
            ...
            'autometric.experiments.pullback_comparison': { 'autometric.experiments.pullback_comparison.PullbackComparisonDataset': ( 'experiments/1-comparing-pullback-types.html#pullbackcomparisondataset',
                                                            ...
                                                            'autometric.experiments.pullback_comparison.PullbackComparisonDataset.get_truth': ( 'experiments/1-comparing-pullback-types.html#pullbackcomparisondataset.get_truth',
                                                                                                                                                'autometric/experiments/pullback_comparison.py')},
            'autometric.geodesics_jax': { 'autometric.geodesics_jax.DummyOracle': ( 'library/geodesics.html#dummyoracle',
                                                                                    'autometric/geodesics_jax.py'),
                                          'autometric.geodesics_jax.DummyOracle.__init__': ( 'library/geodesics.html#dummyoracle.__init__',
                                                                                             'autometric/geodesics_jax.py'),
                                          'autometric.geodesics_jax.DummyOracle.geo_length': ( 'library/geodesics.html#dummyoracle.geo_length',
                                                                                               'autometric/geodesics_jax.py'),
                                          'autometric.geodesics_jax.DummyOracle.mse_geodesic': ( 'library/geodesics.html#dummyoracle.mse_geodesic',
                                                                                                 'autometric/geodesics_jax.py'),
                                          'autometric.geodesics_jax.GeodesicQuicktrainer': ( 'library/geodesics.html#geodesicquicktrainer',
                                                                                             'autometric/geodesics_jax.py'),
                                          'autometric.geodesics_jax.GeodesicQuicktrainer.__init__': ( 'library/geodesics.html#geodesicquicktrainer.__init__',
                                                                                                      'autometric/geodesics_jax.py'),
                                          'autometric.geodesics_jax.plot_3d_with_geodesics': ( 'library/geodesics.html#plot_3d_with_geodesics',
                                                                                               'autometric/geodesics_jax.py'),
                                          'autometric.geodesics_jax.sample_along_geodesic': ( 'library/geodesics.html#sample_along_geodesic',
                                                                                              'autometric/geodesics_jax.py'),
                                          'autometric.geodesics_jax.visualize_geodesics': ( 'library/geodesics.html#visualize_geodesics',
                                                                                            'autometric/geodesics_jax.py'),
                                          'autometric.geodesics_jax.wrap_torch_metric': ( 'library/geodesics.html#wrap_torch_metric',
                                                                                          'autometric/geodesics_jax.py')},
            'autometric.geometry': {},
