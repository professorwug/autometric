...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'autometric.autometric': { 'autometric.autometric.StringGeodesic': ( 'library/string-geodesics.html#stringgeodesic',
            ...
            'autometric.geodesics': { 'autometric.geodesics.DummyOracle': ('library/geodesics.html#dummyoracle', 'autometric/geodesics.py'),
                                      'autometric.geodesics.DummyOracle.__init__': ( 'library/geodesics.html#dummyoracle.__init__',
                                                                                     'autometric/geodesics.py'),
                                      'autometric.geodesics.DummyOracle.geo_length': ( 'library/geodesics.html#dummyoracle.geo_length',
                                                                                       'autometric/geodesics.py'),
                                      'autometric.geodesics.DummyOracle.mse_geodesic': ( 'library/geodesics.html#dummyoracle.mse_geodesic',
                                                                                         'autometric/geodesics.py'),
                                      'autometric.geodesics.GeodesicQuicktrainer': ( 'library/geodesics.html#geodesicquicktrainer',
                                                                                     'autometric/geodesics.py'),
                                      'autometric.geodesics.GeodesicQuicktrainer.__init__': ( 'library/geodesics.html#geodesicquicktrainer.__init__',
                                                                                              'autometric/geodesics.py'),
